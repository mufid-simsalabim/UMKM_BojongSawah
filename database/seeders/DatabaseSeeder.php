...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        // 1. Create Admin User
        $admin = User::create([
            'name' => 'Administrator Desa Bojong Sawah',
        ...
        $regularUser = User::create([
            'name' => 'Budi Santoso (Warga Bojong Sawah)',
        ...
        $profile1 = UmkmProfile::create([
            ...
            'store_name' => 'Keripik Singkong KASEP Bojong Sawah',
            'phone_wa' => '081234567891',
            'category' => 'Kuliner & Olahan',
            'address' => 'RT 02 / RW 01, Kampung Cikaret, Desa Bojong Sawah',
            'description' => 'Produsen keripik singkong gurih khas Desa Bojong Sawah dengan bumbu balado rahasia keluarga.',
        ...
        $prod1 = Product::create([
            ...
            'category' => 'Kuliner & Olahan',
            'description' => 'Keripik singkong renyah yang diproses dari singkong pilihan hasil tani warga Bojong Sawah, dibalut bumbu balado pedas manis yang bikin ketagihan.',
            'price' => 15000,
            'unit' => 'Bungkus',
            'image' => null,
            'is_active' => true,
        ...
        $post1 = Post::create([
            'user_id' => $user1->id,
            'product_id' => $prod1->id,
            'content' => "Sampurasun warga Desa Bojong Sawah! Stok Keripik Singkong Balado KASEP baru matang dari penggorengan nih. Renyah, gurih, dan siap jadi teman bersantai sore bersama keluarga.\n\nYuk langsung klik tombol pesan di bawah ini untuk pemesanan via WhatsApp!",
            'image' => null,
            'likes_count' => 13,
        ]);
        ...
        $profile2 = UmkmProfile::create([
            ...
            'address' => 'RT 05 / RW 02, Sawah Hilir, Desa Bojong Sawah',
            'description' => 'Menyediakan beras hasil panen sawah asli Desa Bojong Sawah. Pulen, wangi, dan ditanam secara bebas bahan kimia.',
            'ktp_image' => 'images/logo-bojongsawah.png',
        ...
        $prod3 = Product::create([
            'user_id' => $user2->id,
            'name' => 'Beras Pandan Wangi Organik Bojong Sawah 5kg',
            'slug' => Str::slug('Beras Pandan Wangi Organik Bojong Sawah 5kg') . '-3',
            'category' => 'Pertanian & Peternakan',
            'description' => 'Beras pandan wangi unggulan ditanam langsung di persawahan subur Desa Bojong Sawah. Nasi lebih pulen dan beraroma harum alami.',
            'price' => 75000,
            'unit' => 'Karung 5kg',
            'image' => null,
            'is_active' => true,
        ...
        $post2 = Post::create([
            'user_id' => $user2->id,
            'product_id' => $prod3->id,
            'content' => "Alhamdulillah panen raya di persawahan Bojong Sawah melimpah! Beras Pandan Wangi Organik sudah siap dipasarkan. Beras baru giling, nasi dijamin sangat pulen dan harum.\n\nBisa antar langsung ke rumah wilayah Kebonpedes & sekitarnya. Tanya-tanya atau pesan bisa langsung klik WhatsApp di bawah ya!",
            'image' => null,
            'likes_count' => 25,
        ]);
        ...
        UmkmProfile::create([
            ...
            'store_name' => 'Kerajinan Bambu Sunda Bojong Sawah',
            'phone_wa' => '085712345678',
            'category' => 'Kerajinan & Kriya',
            'address' => 'RT 01 / RW 03, Kampung Babakan, Desa Bojong Sawah',
        ...
        Product::create([
            ...
            'category' => 'Kerajinan & Kriya',
            'description' => 'Besek bambu kualitas export buatan tangan warga Bojong Sawah. Cocok untuk wadah souvenir, catering, maupun hampers khas desa.',
            'price' => 25000,
            'unit' => 'Set (2 Pcs)',
            'image' => null,
            'is_active' => true,
        ...
        UmkmProfile::create([
            ...
            'store_name' => 'Warung Nasi Liwet Khas Bojong Sawah',
            'phone_wa' => '082123456789',
            'category' => 'Kuliner & Olahan',
            'address' => 'RT 03 / RW 02, Desa Bojong Sawah',
